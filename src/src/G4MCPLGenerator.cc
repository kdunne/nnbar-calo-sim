...
//std::string filename_event = "./HIBEAM_tsol_signal_GBL_jbar_100k_9000_event_length_info.csv";
//std::string filename_event =HIBEAM_tsol_signal_GBL_jbar_100k_9000_event_length_info.csv
std::string filename_event = "./NNBAR_mfro_signal_GBL_jbar_50k_9001_event_length_info.csv";
...
void G4MCPLGenerator::GeneratePrimaries(G4Event* evt)
{
  ...
  if (m_p->pdgcode==111){
    ...
    Particle_outFile << m_p->ekin << ","; //m_p->ekin
    ...
    //if (sqrt(pow(m_p->position[0],2) + pow(m_p->position[1],2)+pow(m_p->position[2],2))<50.0){
    ...
    << m_p->position[2] << ", d^2:" << sqrt(pow(m_p->position[0],2) + pow(m_p->position[1],2)+pow(m_p->position[2],2))<< " , " << m_p -> time/s << ","  << m_p->direction[0] << "," << m_p->direction[1] << "," << m_p->direction[2] << std::endl;
