...
std::string filename_data_lead_glass_pos = "./lead_glass_position/non_axial.csv";
std::string filename_data_lead_glass_pos_fb = "./lead_glass_position/non_axial_fb.csv";
...
{ 
  ...
  // Concrete shielding ESS standard
  G4Material *Concrete = new G4Material("Concrete", density = 2.3*g/cm3, 10);
  Concrete-> AddElement(elH,1.00e-02);
  Concrete-> AddElement(elC,1.00e-03);
  Concrete-> AddElement(elO,5.29e-01);
  Concrete-> AddElement(elNa,1.6e-02);
  Concrete-> AddElement(elMg,2.00e-03);
  Concrete-> AddElement(elAl,3.39e-02);
  Concrete-> AddElement(elSi,3.37e-01); 
  Concrete-> AddElement(elK,1.3e-02);
  Concrete-> AddElement(elCa,4.4e-02);
  Concrete-> AddElement(elFe,1.4e-02);
...
G4VPhysicalVolume* DetectorConstruction::DefineVolumes()
{
  ...
  auto concreteMaterial = G4Material::GetMaterial("Concrete");
  ...
  // Concrete shielding
  auto shieldXZ = 10.0*m; auto shieldY = 2.0*m;  
  auto shieldS = new G4Box("ShieldS",shieldXZ/2., shieldY/2., shieldXZ/2.);
  auto shieldLV = new G4LogicalVolume(shieldS,concreteMaterial,"ShieldLV");
  auto shieldPV =  new G4PVPlacement(0,G4ThreeVector(0., 3.0*m + shieldY/2., 0.),shieldLV,"ShieldPV",worldLV,false,0,fCheckOverlaps);

  // Silicon
  G4double silicon_radius_1 = 87.97*cm; G4double silicon_radius_2 = 97.97*cm;
  ...
  G4double TPC_layer_x = 1.0*cm; G4double TPC_layer_y = 1.0*cm;

  auto TPCS_layer = new G4Box("TPCS_layer",TPC_layer_x/2.,TPC_layer_y/2.,TPC_z/2.);
  ...
  TPCLV = new G4LogicalVolume(TPCS_layer,TPCMaterial,"TPCLV");

  G4Region* TPC_region = new G4Region("TPC_region");
  TPCLV->SetRegion(TPC_region);
  TPC_region->AddRootLogicalVolume(TPCLV);
  ...
  for (int j = 0; j<TPC_number_y1;j++){
    for (int i = 0; i<TPC_number_x1; i++){
      ...
      new G4PVPlacement(0,TPC_layer_pos,TPCLV,"TPCPV",TPCLV_1,false,TPC_index,fCheckOverlaps);
      TPC_index++;
    }
  }
  ...
  for (int j = 0; j<TPC_number_y2;j++){
    for (int i = 0; i<TPC_number_x2; i++){
      ...
      new G4PVPlacement(0,TPC_layer_pos,TPCLV,"TPCPV",TPCLV_2,false,TPC_index,fCheckOverlaps);
      TPC_index++;
    }
  }
  ...
  scint_Module_PV_array.push_back(new G4PVPlacement(0,scint_pos1,scintLV,"ScintPV1",scint_groupLV,false,0,fCheckOverlaps));
  scint_Module_PV_array.push_back(new G4PVPlacement(0,scint_pos2,scintLV,"ScintPV2",scint_groupLV,false,1,fCheckOverlaps));
  scint_Module_PV_array.push_back(new G4PVPlacement(0,scint_pos3,scintLV,"ScintPV3",scint_groupLV,false,2,fCheckOverlaps));
  scint_Module_PV_array.push_back(new G4PVPlacement(0,scint_pos4,scintLV,"ScintPV4",scint_groupLV,false,3,fCheckOverlaps));
  scint_Module_PV_array.push_back(new G4PVPlacement(0,scint_pos5,scintLV,"ScintPV5",scint_groupLV,false,4,fCheckOverlaps));
  scint_Module_PV_array.push_back(new G4PVPlacement(0,scint_pos6,scintLV,"ScintPV6",scint_groupLV,false,5,fCheckOverlaps));
  scint_Module_PV_array.push_back(new G4PVPlacement(0,scint_pos7,scintLV,"ScintPV7",scint_groupLV,false,6,fCheckOverlaps));
  scint_Module_PV_array.push_back(new G4PVPlacement(0,scint_pos8,scintLV,"ScintPV8",scint_groupLV,false,7,fCheckOverlaps));
  scint_Module_PV_array.push_back(new G4PVPlacement(0,scint_pos9,scintLV,"ScintPV9",scint_groupLV,false,8,fCheckOverlaps));
  ...
  auto scintPV1 = new G4PVPlacement(0,scint_group_pos1,scint_groupLV,"ScintPV_Group1",worldLV,false,0,fCheckOverlaps);
  auto scintPV2 = new G4PVPlacement(zRot2,scint_group_pos2,scint_groupLV,"ScintPV_Group2",worldLV,false,1,fCheckOverlaps);
  auto scintPV3 = new G4PVPlacement(zRot3,scint_group_pos3,scint_groupLV,"ScintPV_Group3",worldLV,false,2,fCheckOverlaps);
  auto scintPV4 = new G4PVPlacement(zRot4,scint_group_pos4,scint_groupLV,"ScintPV_Group4",worldLV,false,3,fCheckOverlaps);
 ...
 // --- horizontal staves (divide y)
  ...
  auto scint_fb_PV1 = new G4PVPlacement(scint_fb_rot,scint_fb_pos1,scint_fb1_LV,"ScintPVfb_Group1",worldLV,false,1,fCheckOverlaps);
  auto scint_fb_PV2 = new G4PVPlacement(scint_fb_rot,scint_fb_pos2,scint_fb1_LV,"ScintPVfb_Group2",worldLV,false,2,fCheckOverlaps);
  auto scint_fb_PV3 = new G4PVPlacement(scint_fb_rot,scint_fb_pos3,scint_fb1_LV,"ScintPVfb_Group3",worldLV,false,3,fCheckOverlaps);
  auto scint_fb_PV4 = new G4PVPlacement(scint_fb_rot,scint_fb_pos4,scint_fb1_LV,"ScintPVfb_Group4",worldLV,false,4,fCheckOverlaps);
  auto scint_fb_PV5 = new G4PVPlacement(scint_fb_rot,scint_fb_pos5,scint_fb2_LV,"ScintPVfb_Group5",worldLV,false,5,fCheckOverlaps);
  auto scint_fb_PV6 = new G4PVPlacement(scint_fb_rot,scint_fb_pos6,scint_fb2_LV,"ScintPVfb_Group6",worldLV,false,6,fCheckOverlaps);
  auto scint_fb_PV7 = new G4PVPlacement(0,scint_fb_pos7,scint_fb1_LV,"ScintPVfb_Group7",worldLV,false,7,fCheckOverlaps);
  auto scint_fb_PV8 = new G4PVPlacement(0,scint_fb_pos8,scint_fb1_LV,"ScintPVfb_Group8",worldLV,false,8,fCheckOverlaps);
  auto scint_fb_PV9 = new G4PVPlacement(0,scint_fb_pos9,scint_fb1_LV,"ScintPVfb_Group9",worldLV,false,9,fCheckOverlaps);
  auto scint_fb_PV10 = new G4PVPlacement(0,scint_fb_pos10,scint_fb1_LV,"ScintPVfb_Group10",worldLV,false,10,fCheckOverlaps);
  auto scint_fb_PV11 = new G4PVPlacement(0,scint_fb_pos11,scint_fb2_LV,"ScintPVfb_Group11",worldLV,false,11,fCheckOverlaps);
  auto scint_fb_PV12 = new G4PVPlacement(0,scint_fb_pos12,scint_fb2_LV,"ScintPVfb_Group12",worldLV,false,12,fCheckOverlaps);
  ...
  ***/
  ...
  // absorberLV->SetVisAttributes(green_color);
  // scint_StaveH_LV->SetVisAttributes(blue_color);
  // scint_StaveV_LV->SetVisAttributes(blue_color);
  // scint_stave_fb1V_LV->SetVisAttributes(blue_color);
  // scint_stave_fb1H_LV->SetVisAttributes(blue_color);
  // scint_stave_fb2V_LV->SetVisAttributes(blue_color);
  // scint_stave_fb2H_LV->SetVisAttributes(blue_color);
  // TPCLV_1->SetVisAttributes(red_color);
  // TPCLV_2->SetVisAttributes(red_color);
...
{ 
  ...
  SetSensitiveDetector("ShieldLV", shieldDetector);
