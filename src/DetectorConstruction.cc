...
G4VPhysicalVolume* DetectorConstruction::DefineVolumes()
{
  ...
  abscut->SetProductionCut(10035.0 *cm,"gamma"); 
  abscut->SetProductionCut(35 *cm,"e-");
  abscut->SetProductionCut(35 *cm,"e+");
  abscut->SetProductionCut(130 *cm,"proton"); // 0.25cm ? 30 cm -> 1.8 MeV ;; 33cm -> 2.55 MeV ;; 34cm -> 2.97 MeV ;; 34.1cm -> 3.0MeV ;; 34.3, 34.6cm, 34.9cm, 35cm -> 10 GeV
